import { SecondaryDialogProvider, IDialogShowOptions } from './Dialog';
/**
...
declare abstract class BaseDialog {
    ...
    /**
     * If the dialog is visually hidden. This happens when the dialog goes behind a secondary dialog.
     ...
     */
    readonly secondaryDialogProvider: SecondaryDialogProvider | undefined;
    /**
     ...
     * framework. Use this.domElement to access this container. The container is inside a modal rendered in the center
     * of the page on top of a dark overlay.
     *
     * @remarks
     * The render method is called once after the modal element is created and opened. It is recommended to
     * use onBeforeOpen() for doing non-UI preperations for your rendering that might take a long time. This
     ...
     * lifecycle completes after closing and there should be no resources left inside the object. Even though
     ...
     */
    private _requestAck(requestId, isSecondary?);
}
