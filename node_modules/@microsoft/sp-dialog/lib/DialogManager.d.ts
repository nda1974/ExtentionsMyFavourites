...
import { IDialogShowOptions, IAlertOptions, IPromptOptions } from './Dialog';
...
export default class DialogManager {
    ...
    private _removeRequest(reqId, shouldResolve);
    private _hide(dialog);
    private _unhide(dialog);
    private _getUiComponent(dialog);
    private _open(dialog);
    /**
     ...
     */
    private _hasPermissionToShow(requestId);
    private _getRequestById(id);
}
